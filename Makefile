#############################################################################
# Makefile for building: IDJ-2019-Trab6
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  IDJ-2019-Trab6.pro
# Template: app
# Command: C:\Qt\5.2.1\mingw48_32\bin\qmake.exe -spec win32-g++ CONFIG+=qml_debug CONFIG+=force_debug_info CONFIG+=separate_debug_info -o Makefile IDJ-2019-Trab6.pro
#############################################################################
...
Makefile: IDJ-2019-Trab6.pro ../../../../../Qt/5.2.1/mingw48_32/mkspecs/win32-g++/qmake.conf ../../../../../Qt/5.2.1/mingw48_32/mkspecs/features/spec_pre.prf \
		...
		IDJ-2019-Trab6.pro
	$(QMAKE) -spec win32-g++ CONFIG+=qml_debug CONFIG+=force_debug_info CONFIG+=separate_debug_info -o Makefile IDJ-2019-Trab6.pro
